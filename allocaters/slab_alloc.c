...
static const uint64_t sizes[] = {sizeof(buddy_node_t), PAGE_SIZE, sizeof(dentry_t), sizeof(inode_t), sizeof(dcache_entry_t), sizeof(block_device_t),
     sizeof(block_device_node_t), sizeof(partition_device_t), sizeof(superblock_t), sizeof(fat32_internal_info_t)};
static const uint64_t slab_sizes[] = {4, 32, 4, 4, 4, 4, 1, 1, 1, 1};
