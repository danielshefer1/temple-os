...
#define MMIO_VIRTUAL 0xF0000000
...
#define RW_KERNEL (PRESENT_PAGE | RW_PAGE | GLOBAL_PAGE)
#define R_KERNEL (PRESENT_PAGE | GLOBAL_PAGE)

#define RW_USER (PRESENT_PAGE | RW_PAGE | USER_PAGE)
#define R_USER (PRESENT_PAGE | USER_PAGE)

#define RW_MMIO (PRESENT_PAGE | RW_PAGE | WRITE_THROUGH_PAGE | CACHE_DIS_PAGE | GLOBAL_PAGE)
